...
const styles = StyleSheet.create({
  ...
  dateBadge: { backgroundColor: '#fff', borderColor: '#e2e8f0', borderRadius: 10, borderWidth: 1, color: '#475569', fontSize: 11, padding: 8 },
  goalToolbar: { alignItems: 'center', flexDirection: 'row', gap: 8, marginBottom: 12 },
  goalList: { gap: 8 },
  goalChip: { backgroundColor: '#e2e8f0', borderRadius: 10, minWidth: 126, paddingHorizontal: 11, paddingVertical: 7 },
  activeGoalChip: { backgroundColor: '#dbeafe' },
  goalChipText: { color: '#475569', fontSize: 11, fontWeight: '700' },
  goalChipAmount: { color: '#64748b', fontSize: 10, marginTop: 2 },
  activeGoalChipText: { color: '#1d4ed8' },
  outlineButton: { borderColor: '#2563eb', borderRadius: 9, borderWidth: 1, paddingHorizontal: 11, paddingVertical: 8 },
  outlineButtonText: { color: '#2563eb', fontSize: 11, fontWeight: '700' },
  newGoalCard: { marginBottom: 12 },
  newGoalFields: { alignItems: 'flex-end', flexDirection: 'row', gap: 10 },
  fieldGrow: { flex: 1 },
  targetField: { width: 150 },
  tabs: { alignSelf: 'flex-start', backgroundColor: '#e2e8f0', borderRadius: 12, flexDirection: 'row', gap: 3, marginBottom: 14, padding: 3 },
  tab: { borderRadius: 9, paddingHorizontal: 13, paddingVertical: 8 },
  activeTab: { backgroundColor: '#fff' },
  tabText: { color: '#64748b', fontSize: 13, fontWeight: '600' },
  activeTabText: { color: '#0f172a' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  card: { backgroundColor: '#fff', borderColor: '#e2e8f0', borderRadius: 16, borderWidth: 1, flexBasis: 360, flexGrow: 1, padding: 16 },
  cardWide: { flexBasis: '100%' },
  label: { color: '#64748b', fontSize: 10, fontWeight: '700', letterSpacing: 1, marginBottom: 8, textTransform: 'uppercase' },
  bigValue: { color: '#0f172a', fontSize: 25, fontWeight: '700' },
  targetValue: { color: '#94a3b8', fontSize: 14, fontWeight: '500' },
  muted: { color: '#64748b', fontSize: 13 },
  progressHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 7, marginTop: 18 },
  ...
  editBox: { backgroundColor: '#f8fafc', borderColor: '#e2e8f0', borderRadius: 10, borderWidth: 1, marginTop: 14, padding: 10 },
  inputLabel: { color: '#475569', fontSize: 11, fontWeight: '600', marginBottom: 5 },
  input: { backgroundColor: '#fff', borderColor: '#e2e8f0', borderRadius: 9, borderWidth: 1, color: '#0f172a', fontSize: 14, padding: 10 },
  primaryButton: { alignItems: 'center', backgroundColor: '#2563eb', borderRadius: 9, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 10 },
  primaryButtonText: { color: '#fff', fontSize: 12, fontWeight: '700' },
  disabledButton: { backgroundColor: '#94a3b8' },
  summaryList: { gap: 11, marginTop: 8 },
